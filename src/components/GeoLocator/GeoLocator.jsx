    ...
    return (
        ...
        >
            ...
            >
                ...
                <p style={{ fontFamily: 'Montserrat', fontSize: '1.4em' }}>
                    Geo Locator is an open-source and free to play alternative to the game Geoguessr.
                    <br />
                    To play you need a Google api key, which you can either create by yourself following{' '}
                    <a href="https://github.com/RasterCrow/Geo-Locator/wiki" target="__noBlank">
                        this tutorial{' '}
                    </a>{' '}
                    or you can use the one I provide, which has daily limits on the number of games you can play.
                    <br /> You can view the source code on the{' '}
                    <a href="https://github.com/RasterCrow/Geo-Locator" target="__noBlank">
                        Github page
                    </a>
